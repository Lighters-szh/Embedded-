...
//    #error "请在此处理可下发可上报数据及只上报数据示例,处理完成后删除该行"
    ...
    mcu_dp_string_update(DPID_SCENE_DATA,0,0); //STRING型数据上报;
    mcu_dp_value_update(DPID_COUNTDOWN,0); //VALUE型数据上报;
    mcu_dp_string_update(DPID_MUSIC_DATA,0,0); //STRING型数据上报;
    mcu_dp_string_update(DPID_CONTROL_DATA,0,0); //STRING型数据上报;
}
